...
@interface LYHistoryViewController ()<UICollectionViewDataSource,UICollectionViewDelegate>
...
@implementation LYHistoryViewController
#pragma mark --懒加载
...
- (void)deleteClick{
    ...
    [self.deals addObjectsFromArray:[LYDetailTool historyDeals]];
    [self.collectionView reloadData];
}
